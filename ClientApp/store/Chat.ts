...
type KnownAction = SetHubAction | MessageReceivedAction | ConnectedUsersAction | NewUserAddedAction | SetNameAction;
...
export const reducer: Reducer<ChatState> = (state: ChatState, action: KnownAction) => {
    switch (action.type) {
        ...
        case 'MESSAGE_RECEIVED':
            ...
            return Object.assign({}, state, { messages: [...state.messages, { originatorUser: action.originatorUser, message: action.message }] });
